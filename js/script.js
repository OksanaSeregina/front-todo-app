const getData = () => {
  fetch("https://todo-app-12341.herokuapp.com/api/tutorials")
    .then((req) => {
      return req.json();
    })
    .then((data) => {
...
document.addEventListener("click", function (e) {
  ...
  //console.log(elem);
  if (
    elem.closest("#modal1") !== modal &&
    !elem.classList.contains("edit-btn")
  ) {
...
const putData = (id) => {
  ...
  fetch(`https://todo-app-12341.herokuapp.com/api/tutorials/${id}`, {
    method: "PUT",
    body: JSON.stringify({
      title: inputName,
      description: descrName,
